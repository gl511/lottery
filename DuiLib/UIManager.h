...
public:
	...
	const TImageInfo* AddImage(LPCTSTR bitmap, LPCTSTR szFilePath, bool bAlpha);
...
UILIB_API BOOL LoadLocalPictureToStream(LPCTSTR strPicPath, IStream *&pStream, DWORD &dwSize);

UILIB_API HBITMAP LoadLocalPictureToBmp(LPCTSTR strPicPath);

UILIB_API bool DrawAlpha(Image *pBgImg, HWND hWnd, BLENDFUNCTION *pBlend);

...
BEGIN_MESSAGE_MAP(CLotteryDlg, CDialog)
	...
	ON_WM_QUERYDRAGICON()
	//}}AFX_MSG_MAP
	ON_BN_CLICKED(IDOK, &CLotteryDlg::OnBnClickedOk)
	ON_BN_CLICKED(IDCANCEL, &CLotteryDlg::OnBnClickedCancel)
END_MESSAGE_MAP()
...
BOOL CLotteryDlg::OnInitDialog()
{
	...
	m_DUIManWnd.Create(NULL, _T("抽奖"), UI_WNDSTYLE_FRAME, 0, 0, 0, 0);
	m_DUIManWnd.CenterWindow();
	m_DUIManWnd.ShowWindow(true);
...
void CLotteryDlg::OnBnClickedOk()
{
	// TODO: 在此添加控件通知处理程序代码
	//OnOK();
}

void CLotteryDlg::OnBnClickedCancel()
{
	// TODO: 在此添加控件通知处理程序代码
	//OnCancel();
}
